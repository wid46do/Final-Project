      ...
      <header className="home-header">
        <nav className="home-navbar">
          <div className="logo-wrapper">
            ...
            >
              <FiMenu style={{width: '24px', height: '24px', cursor: 'pointer'}}/>
            </div>
            <div className="home-search">
              <FiSearch style={{width: '24px', height: '24px', cursor: 'pointer'}}/>
          ...
          >
            <div className="home-menu">
              <h4 className="brand-title">
                Second Hand
                <IoClose style={{width: '24px', height: '24px', cursor: 'pointer'}} onClick={() => setEnableBell(!openSideBar)}/>
              </h4>
              <ul className="profile-account-wrapper">
                ...
                <li onClick={() => dropClose(!dropOpen)}>
                  ...
                  <div className={`${dropOpen ? "dropdown-open" : "dropdown-closed"}`}>
                    <ul>
                      <li><Link style={{textDecoration: 'none', color: '#000000'}} to={'/profile'}>Ubah Akun</Link></li>
                      <li><Link style={{textDecoration: 'none', color: '#000000'}} to={'/'}>Pengaturan Akun</Link></li>
                      <li><Link style={{textDecoration: 'none', color: '#000000'}} to={'/'}>Keluar</Link></li>
                    </ul>
                  </div>
                </li>
              </ul>
